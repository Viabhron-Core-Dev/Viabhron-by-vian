...
export function MiniAppLoader({ 
  ...
  return (
    <div className="h-full flex flex-col bg-white overflow-hidden relative">
      {uiMode === 'vaa' && !activeAppId ? (
        <div className="flex-1 flex flex-col">
          <div className="p-6 border-b border-slate-100 bg-white">
            <h2 className="text-xl font-black text-slate-900 uppercase tracking-tighter">Viabhronic Loader</h2>
            <p className="text-[10px] text-slate-400 uppercase tracking-[0.3em] font-bold">Substrate Placeholder</p>
          </div>
          ...
          <div className="p-8 text-center space-y-4">
            ...
            <p className="text-xs text-slate-400 max-w-[200px] mx-auto leading-relaxed uppercase tracking-widest font-bold">
              No mini-apps or games have been hatched in this substrate yet.
            </p>
          </div>
        </div>
      ) : (
